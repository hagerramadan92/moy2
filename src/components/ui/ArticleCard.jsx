  ...
  return (
    <div className="w-full max-w-[555.48px] h-[509.55px] bg-white 
      ...
      <div className="absolute top-[321.48px] right-[27.47px] w-[329px]">
        <h3 className="font-cairo font-semibold text-[21.87px] leading-[100%] text-right text-[#579BE8] tracking-[-0.76px] whitespace-nowrap">
          {title}
        </h3>
      </div>

      <div className="absolute top-[361.94px] right-[26.76px] w-[415px]">
        <p className="font-cairo font-normal text-[15.31px] leading-[100%] text-right text-[#757575] tracking-[-0.76px] whitespace-nowrap">
          {description}
        </p>
      </div>

      <div className="absolute top-[403.49px] left-1/2 transform -translate-x-1/2 w-[500.8px] h-[0px]">
        <div className="w-full border-t-[0.87px] border-[#579BE8]"></div>
      </div>

      <div className="absolute top-[419.89px] right-[27.91px] w-auto h-[28.43px] flex items-center gap-[4.37px]" dir="rtl">
      ...
      <div className="absolute top-[455.97px] right-[27.91px] w-auto h-[26.24px] flex items-center gap-[4.37px]" dir="rtl">
      ...
      <div className="absolute top-[420.98px] left-[27.91px] w-auto h-[26.24px] flex items-center gap-[4.37px]">
        <div className="relative w-[26.24px] h-[26.24px] flex-shrink-0">
          <Image
            src={timeIconUrl}
            alt="time"
